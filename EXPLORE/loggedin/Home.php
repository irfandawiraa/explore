                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="MyTrip.php">My Trip</a>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block" style="margin-bottom: 25%;">
                    ...
                    <a href="Order.php" class="btn btn-outline-light" role="button" aria-pressed="true"
                        style="font-size: 30px;">Pesan Sekarang</a>
                </div>
            </div>
