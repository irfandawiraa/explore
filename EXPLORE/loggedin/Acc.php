...
<head>
    ...
    <title>EXPLORE: Konfirmasi Pembayaran</title>
                ...
                <blockquote class="blockquote mb-0">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            include '../koneksi.php';
                            $idakun = $_SESSION['id'];
                            $data = mysqli_query($koneksi,"select * from transaction where status='Menunggu Konfirmasi'");
                            ...
                            <tr>
                                ...
                                <td>
                                    <a action="booking.php" class="btn btn-primary btn-sm"
                                        href="KonfAcc.php?id=<?php echo $d['id']; ?>" role="Button">Detail</a>
                                </td>
                            </tr>
                            <?php 
                            }
