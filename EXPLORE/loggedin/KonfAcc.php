...
<head>
    ...
    <title>EXPLORE: Konfirmasi Perjalanan</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                ...
                ?>
                <img src="../gambar/<?php echo $d['buktibayar']; ?>" style="max-width: 720px; max-height: 500px;">
            </div>
            <div class="col-sm-4">
                <div align="center">
                    <div class="card" style="width: 30rem;">
                        <div class="card-body" style="text-align: left;">
                            ...
                            <form method="POST" action="konf_acc.php">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" class="form-control" value="<?php echo $d['jmlorang']; ?>"
                                        readonly name="jmlorang" placeholder="Jumlah orang">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="in">Keberangkatan</label><br>
                                    <input type="date" class="form-control"
                                        value="<?php echo $d['tanggal_berangkat']; ?>" name="berangkat" readonly>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="telp">Nomor Telp</label>
                                    <input type="number" class="form-control" value="<?php echo $d['hp']; ?>" readonly
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group is-invalid">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $d['harga']; ?>"
                                            readonly name="harga" placeholder="Harga">
                                    </div>
                                </div>
                                <div>
                                    <input type="hidden" name="id" value="<?php echo $d['id'] ?>">
                                ...
                                <div align="center">
                                    <input type="submit" class="btn btn-primary" id="save" value="Konfirmasi"
