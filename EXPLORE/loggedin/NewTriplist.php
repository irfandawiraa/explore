...
<head>
    ...
    <title>EXPLORE: Add Trip List</title>
...
<body background="../pictures/borobudur.jpg">
    ...
    <div align="center" style="margin-top: 30px;">
        <div class="card w-50">
            <div class="card-body">
                <h3 class="card-title">Add Trip List</h3>
                <form action="addTriplist.php" method="POST" enctype="multipart/form-data" style="text-align: left;">
                    ...
                    <div class="form-group">
                        <label for="gambar">Foto Tujuan</label>
                        <input type="file" class="form-control-file" id="gambar" name="gambar" required>
                    </div>
                    <div align="center">
                        <button type="submit" class="btn btn-primary">Add Trip List</button>
                    </div>
                </form>
            </div>
        </div>
